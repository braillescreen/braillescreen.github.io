...
BLOG_AUTHOR = "Patrick Wilson"  # (translatable)
BLOG_TITLE = "BrailleScreen's Site"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://braillescreen.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://braillescreen.github.io/"
BLOG_EMAIL = "patrick@pwry.net"
BLOG_DESCRIPTION = "My space on the internet."  # (translatable)
